...
'* Name:        SQLHelper.vb
'*
'* Description: Wrapper class for ADO.NET. This class forms part of the .NET 
'*              Data Access Architecture Guide. For more information, see
'*              http://msdn/microsoft.com/library/default.asp?url=/library/en-us/dndba/html/daag.asp
'*
'*-----------------------------------------------------------------------------
'*                      CHANGE HISTORY
'*   Change No:   Date:          Author:   Description:
'*   _________    ___________    ______    ____________________________________
'*      001       01-May-2002    MS        Microsoft are the original authors
'* 
'******************************************************************************        
...
#Region "private utility methods & constructors"
    ...
    '********************************************************************
    ' Generate a string for a variable that is passed as a SQL text command.
    ' In the case of strings, single quotes are changed to '' because SQL uses the 
    ' single quote as a string delimitter.
    ' Parameters:
    '   str - variable that will be converted to a string
    '   IncludeWildCard - optional boolean which indicates if we should return a string with a wildcard ('%') token
    ' Returns: a string that can be used in a SQL command
    Public Shared Function SQLString(ByVal str As Object, Optional ByVal IncludeWildCard As Boolean = False) As String
        ...
        '    Return "#" & str & "#"
        'End If
        If str.GetType Is "string".GetType Then
...
#End Region
    ...
    Private Overloads Shared Function ExecuteReader(ByVal commandType As CommandType, ByVal spName As String, ByVal commandParameters As SqlParameter()) As SqlDataReader
