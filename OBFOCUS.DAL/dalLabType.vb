...
#Region "Main procedures - GetComboDual, Add, Update & Delete"
    ...
    Public Function Update(ByVal ID As Integer, _
        ...
        arParameters(Me.DescriptionsFields.fldID) = New SqlParameter("@LabTypeID", SqlDbType.Int)
        arParameters(Me.DescriptionsFields.fldID).Value = ID
        arParameters(Me.DescriptionsFields.fldName) = New SqlParameter("@LabName", SqlDbType.NVarChar, 100)
