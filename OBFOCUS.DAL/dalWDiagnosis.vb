...
#Region "Main procedures - GetWDiagnosis, Add, Update & Delete"
    ...
    '*
    '**************************************************************************
    Public Function GetWDiagnosis(ByVal ChartID As Integer) As SqlDataReader
        ...
        Try
            If Me.Transaction Is Nothing Then
                Return SqlHelper.ExecuteReader(Globals.ConnectionString, CommandType.StoredProcedure, "spWDiagnosisGet", arParameters)
            Else
                Return SqlHelper.ExecuteReader(Me.Transaction, CommandType.StoredProcedure, "spWDiagnosisGet", arParameters)
            End If
    ...
    '*
    '**************************************************************************
    Public Function Update(ByVal WDiagnosis As Integer, _
        ...
        arParameters(0) = New SqlParameter("@WDiagnosis", SqlDbType.Int)
        arParameters(0).Value = WDiagnosis
        arParameters(1) = New SqlParameter("@DiagnosisID", SqlDbType.Int)
        arParameters(1).Value = DiagnosisID
        ...
        Try
            If Me.Transaction Is Nothing Then
                intRecordsAffected = SqlHelper.ExecuteNonQuery(Globals.ConnectionString, CommandType.StoredProcedure, "spWDiagnosisUpdate", arParameters)
            Else
                intRecordsAffected = SqlHelper.ExecuteNonQuery(Me.Transaction, CommandType.StoredProcedure, "spWDiagnosisUpdate", arParameters)
            End If
    ...
    Public Function Add(ByRef ID As Integer, _
        ...
        arParameters(2) = New SqlParameter("@DiagnosisID", SqlDbType.Int)
        arParameters(2).Value = DiagnosisID
        arParameters(3) = New SqlParameter("@UserID", SqlDbType.NVarChar, 50)
        arParameters(3).Value = UserID
        ' Call stored procedure
        Try
            If Me.Transaction Is Nothing Then
                intRecordsAffected = SqlHelper.ExecuteNonQuery(Globals.ConnectionString, CommandType.StoredProcedure, "spWDiagnosisInsert", arParameters)
            Else
                intRecordsAffected = SqlHelper.ExecuteNonQuery(Me.Transaction, CommandType.StoredProcedure, "spWDiagnosisInsert", arParameters)
            End If
        Catch exception As Exception
            ExceptionManager.Publish(exception)
        End Try
    ...
    '*
    '**************************************************************************
    Public Function Delete(ByVal WDiagnosis As Integer) As Boolean
        ...
        Try
            If Me.Transaction Is Nothing Then
                intRecordsAffected = SqlHelper.ExecuteNonQuery(Globals.ConnectionString, CommandType.StoredProcedure, "spWDiagnosisDelete", arParameters)
            Else
                intRecordsAffected = SqlHelper.ExecuteNonQuery(Me.Transaction, CommandType.StoredProcedure, "spWDiagnosisDelete", arParameters)
            End If
        Catch exception As Exception
            ExceptionManager.Publish(exception)
        End Try
