...
#Region "Main procedures - GetComboDual, Add, Update & Delete"
    ...
    '*
    '**************************************************************************
    Public Function GetByKey(ByVal InternalOSID As Integer, _
        ...
        arParameters(Me.ClasssFields.fldID) = New SqlParameter("@InternalOSID", SqlDbType.Int)
        arParameters(Me.ClasssFields.fldID).Value = InternalOSID
        ...
        Try
            If Me.Transaction Is Nothing Then
                SqlHelper.ExecuteNonQuery(Globals.ConnectionString, CommandType.StoredProcedure, "spInternalOSGetByKey", arParameters)
            Else
                SqlHelper.ExecuteNonQuery(Me.Transaction, CommandType.StoredProcedure, "spInternalOSGetByKey", arParameters)
            End If
    ...
    '*
    '**************************************************************************
    Public Function Update(ByVal InternalOSID As Integer, _
        ...
        Try
            If Me.Transaction Is Nothing Then
                intRecordsAffected = SqlHelper.ExecuteNonQuery(Globals.ConnectionString, CommandType.StoredProcedure, "spInternalOSUpdate", arParameters)
            Else
                intRecordsAffected = SqlHelper.ExecuteNonQuery(Me.Transaction, CommandType.StoredProcedure, "spInternalOSUpdate", arParameters)
            End If
    ...
    '*
    '**************************************************************************
    Public Function Add(ByRef InternalOSID As Integer, _
                ByVal Name As String, _
                ByVal Description As String) As Boolean
        ...
        Try
            If Me.Transaction Is Nothing Then
                intRecordsAffected = SqlHelper.ExecuteNonQuery(Globals.ConnectionString, CommandType.StoredProcedure, "spInternalOSInsert", arParameters)
            Else
                intRecordsAffected = SqlHelper.ExecuteNonQuery(Me.Transaction, CommandType.StoredProcedure, "spInternalOSInsert", arParameters)
            End If
        Catch exception As Exception
            ExceptionManager.Publish(exception)
        End Try
        ...
        If intRecordsAffected = 0 Then
            Return False
        Else
            InternalOSID = CType(arParameters(0).Value, Integer)
            Return True
        End If
    End Function
    ...
    Public Function Delete(ByVal ID As Integer) As Boolean
        ...
        ' Set the stored procedure parameters
        arParameters(0) = New SqlParameter("@InternalOSID", SqlDbType.Int)
        arParameters(0).Value = ID

        ' Call stored procedure
        Try
            If Me.Transaction Is Nothing Then
                intRecordsAffected = SqlHelper.ExecuteNonQuery(Globals.ConnectionString, CommandType.StoredProcedure, "spInternalOSDelete", arParameters)
            Else
                intRecordsAffected = SqlHelper.ExecuteNonQuery(Me.Transaction, CommandType.StoredProcedure, "spInternalOSDelete", arParameters)
            End If
        Catch exception As Exception
            ExceptionManager.Publish(exception)
        End Try
