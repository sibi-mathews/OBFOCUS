...
#Region "Main procedures - Add, Update & Delete"
    ...
    '*
    '**************************************************************************
    Public Function GetAssessment(ByVal ExaminerID As Integer) As SqlDataReader
        ...
        Try
            ...
            If ExaminerID = Nothing Or ExaminerID = 0 Then
            ...
            If Me.Transaction Is Nothing Then
                Return SqlHelper.ExecuteReader(Globals.ConnectionString, CommandType.StoredProcedure, "spAssessmentGet", arParameters)
            Else
                Return SqlHelper.ExecuteReader(Me.Transaction, CommandType.StoredProcedure, "spAssessmentGet", arParameters)
            End If
        Catch ex As Exception
            ExceptionManager.Publish(ex)
        End Try
    End Function 'GetAssessment
    '**************************************************************************
    '*  
    '* Name:        GetPharmacy
    '*
    ...
    Public Function GetPharmacy() As SqlDataReader
        ...
        Try
            If Me.Transaction Is Nothing Then
                Return SqlHelper.ExecuteReader(Globals.ConnectionString, CommandType.StoredProcedure, "spPharmacyGetAll")
            Else
                Return SqlHelper.ExecuteReader(Me.Transaction, CommandType.StoredProcedure, "spPharmacyGetAll")
            End If
        Catch ex As Exception
            ExceptionManager.Publish(ex)
        End Try
    ...
    '* Name:        GetComplaints
    '*
    '* Description: Returns all records in the [Complaints] table according
    '*              to specified criteria.
    '*
    '*
    '* Returns:     DataReader containing the specified data. 
    '*
    '**************************************************************************
    Public Function GetComplaints(ByVal ExaminerID As Integer) As SqlDataReader
        ' Call stored procedure and return the data
        Try
            Dim arParameters(0) As SqlParameter         ' Array to hold stored procedure parameters
            ' Set the parameters
            ...
            If Me.Transaction Is Nothing Then
                Return SqlHelper.ExecuteReader(Globals.ConnectionString, CommandType.StoredProcedure, "spComplaintsGet", arParameters)
            Else
                Return SqlHelper.ExecuteReader(Me.Transaction, CommandType.StoredProcedure, "spComplaintsGet", arParameters)
            End If
        Catch ex As Exception
            ExceptionManager.Publish(ex)
        End Try
    End Function 'GetComplaints
    '**************************************************************************
    '*  
    '* Name:        GetPatientInfo
    '*
    ...
    '*
    '**************************************************************************
    Public Function GetPatientInfo() As SqlDataReader
        ' Call stored procedure and return the data
        Try

            If Me.Transaction Is Nothing Then
                Return SqlHelper.ExecuteReader(Globals.ConnectionString, CommandType.StoredProcedure, "spPatientInfoGetDOB")
            Else
                Return SqlHelper.ExecuteReader(Me.Transaction, CommandType.StoredProcedure, "spPatientInfoGetDOB")
            End If
        Catch ex As Exception
            ExceptionManager.Publish(ex)
        End Try
    End Function 'GetPatientInfo
    '**************************************************************************
    '*  
    '* Name:        GetTeratogen
    '*
    ...
    '*
    '**************************************************************************
    Public Function GetTeratogen() As SqlDataReader
        ' Call stored procedure and return the data
        Try
            If Me.Transaction Is Nothing Then
                Return SqlHelper.ExecuteReader(Globals.ConnectionString, CommandType.StoredProcedure, "spTeratogenGet")
            Else
                Return SqlHelper.ExecuteReader(Me.Transaction, CommandType.StoredProcedure, "spTeratogenGet")
            End If
        Catch ex As Exception
            ExceptionManager.Publish(ex)
        End Try
    End Function 'GetTeratogen
    '**************************************************************************
    '*  
    '* Name:        Update
    '*
