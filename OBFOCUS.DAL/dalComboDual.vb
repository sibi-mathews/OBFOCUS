...
#Region "Main procedures - GetComboDual, Add, Update & Delete"
    ...
    '*
    '**************************************************************************
    Public Function GetDiagnosis(ByVal Diagnosis As String, Optional ByVal ActiveOnly As Short = 1) As SqlDataReader
    ...
    '*
    '**************************************************************************
    Public Function GetReference() As SqlDataReader

        ' Call stored procedure and return the data
        Try
            If Me.Transaction Is Nothing Then
                Return SqlHelper.ExecuteReader(Globals.ConnectionString, CommandType.StoredProcedure, "spReferenceTopicGet")
            Else
                Return SqlHelper.ExecuteReader(Me.Transaction, CommandType.StoredProcedure, "spReferenceTopicGet")
            End If
        Catch ex As Exception
            ExceptionManager.Publish(ex)
        End Try
    ...
    '*
    '**************************************************************************
    Public Function GetFlagDescription() As SqlDataReader

        ' Call stored procedure and return the data
        Try
            If Me.Transaction Is Nothing Then
                Return SqlHelper.ExecuteReader(Globals.ConnectionString, CommandType.StoredProcedure, "spFlagDescriptionGet")
            Else
                Return SqlHelper.ExecuteReader(Me.Transaction, CommandType.StoredProcedure, "spFlagDescriptionGet")
            End If
        Catch ex As Exception
            ExceptionManager.Publish(ex)
        End Try
    ...
    '*
    '**************************************************************************
    Public Function GetInternalOS() As SqlDataReader

        ' Call stored procedure and return the data
        Try
            If Me.Transaction Is Nothing Then
                Return SqlHelper.ExecuteReader(Globals.ConnectionString, CommandType.StoredProcedure, "spInternalOSGet")
            Else
                Return SqlHelper.ExecuteReader(Me.Transaction, CommandType.StoredProcedure, "spInternalOSGet")
            End If
        Catch ex As Exception
            ExceptionManager.Publish(ex)
        End Try
    ...
    '*
    '**************************************************************************
    Public Function GetService() As SqlDataReader

        ' Call stored procedure and return the data
        Try
            If Me.Transaction Is Nothing Then
                Return SqlHelper.ExecuteReader(Globals.ConnectionString, CommandType.StoredProcedure, "spServiceGet")
            Else
                Return SqlHelper.ExecuteReader(Me.Transaction, CommandType.StoredProcedure, "spServiceGet")
            End If
        Catch ex As Exception
            ExceptionManager.Publish(ex)
        End Try
    ...
    '*
    '**************************************************************************
    Public Function GetReportType() As SqlDataReader

        ' Call stored procedure and return the data
        Try
            If Me.Transaction Is Nothing Then
                Return SqlHelper.ExecuteReader(Globals.ConnectionString, CommandType.StoredProcedure, "spReportTypeGet")
            Else
                Return SqlHelper.ExecuteReader(Me.Transaction, CommandType.StoredProcedure, "spReportTypeGet")
            End If
        Catch ex As Exception
            ExceptionManager.Publish(ex)
        End Try
    ...
    '*
    '**************************************************************************
    Public Function GettblImages(ByVal ImageCategory As String) As SqlDataReader

        ' Call stored procedure and return the data
        Try
            Dim arParameters(0) As SqlParameter         ' Array to hold stored procedure parameters
            ' Set the parameters
            arParameters(0) = New SqlParameter("@ImageCategory", SqlDbType.NVarChar, 50)
            arParameters(0).Value = ImageCategory
            If Me.Transaction Is Nothing Then
                Return SqlHelper.ExecuteReader(Globals.ConnectionString, CommandType.StoredProcedure, "sptblImagesGet", arParameters)
            Else
                Return SqlHelper.ExecuteReader(Me.Transaction, CommandType.StoredProcedure, "sptblImagesGet", arParameters)
            End If
        Catch ex As Exception
            ExceptionManager.Publish(ex)
        End Try
    ...
    Public Function GetAllergyType() As SqlDataReader
        ...
        Try
            If Me.Transaction Is Nothing Then
                Return SqlHelper.ExecuteReader(Globals.ConnectionString, CommandType.StoredProcedure, "spAllergyTypeGet")
            Else
                Return SqlHelper.ExecuteReader(Me.Transaction, CommandType.StoredProcedure, "spAllergyTypeGet")
            End If
        Catch ex As Exception
            ExceptionManager.Publish(ex)
        End Try
    ...
    '*
    '**************************************************************************
    Public Function GetGraphs() As SqlDataReader

        ' Call stored procedure and return the data
        Try
            If Me.Transaction Is Nothing Then
                Return SqlHelper.ExecuteReader(Globals.ConnectionString, CommandType.StoredProcedure, "spGraphsGet")
            Else
                Return SqlHelper.ExecuteReader(Me.Transaction, CommandType.StoredProcedure, "spGraphsGet")
            End If
        Catch ex As Exception
            ExceptionManager.Publish(ex)
        End Try
    ...
    '*
    '**************************************************************************
    Public Function GetOrderSet() As SqlDataReader

        ' Call stored procedure and return the data
        Try
            If Me.Transaction Is Nothing Then
                Return SqlHelper.ExecuteReader(Globals.ConnectionString, CommandType.StoredProcedure, "spOrderSetGet")
            Else
                Return SqlHelper.ExecuteReader(Me.Transaction, CommandType.StoredProcedure, "spOrderSetGet")
            End If
        Catch ex As Exception
            ExceptionManager.Publish(ex)
        End Try
    ...
    '*
    '**************************************************************************
    Public Function GetFetusAnatomy() As SqlDataReader

        ' Call stored procedure and return the data
        Try
            If Me.Transaction Is Nothing Then
                Return SqlHelper.ExecuteReader(Globals.ConnectionString, CommandType.StoredProcedure, "spFetusAnatomyGet")
            Else
                Return SqlHelper.ExecuteReader(Me.Transaction, CommandType.StoredProcedure, "spFetusAnatomyGet")
            End If
        Catch ex As Exception
            ExceptionManager.Publish(ex)
        End Try
    ...
    '*
    '**************************************************************************
    Public Function GetPlacenta() As SqlDataReader

        ' Call stored procedure and return the data
        Try
            If Me.Transaction Is Nothing Then
                Return SqlHelper.ExecuteReader(Globals.ConnectionString, CommandType.StoredProcedure, "spPlacentaGet")
            Else
                Return SqlHelper.ExecuteReader(Me.Transaction, CommandType.StoredProcedure, "spPlacentaGet")
            End If
        Catch ex As Exception
            ExceptionManager.Publish(ex)
        End Try
